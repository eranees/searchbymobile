...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            <span class="navbar-brand"><a href="<?= base_url()?>dashboard">Home</a></span>
              <span class="navbar-brand" >EDIT CONTACT</span>
          </div>
    ...
    ?>
     <?php echo form_open_multipart("dashboard/editUserPhone",['class'=>'form-horizontal']); ?>
    ...
    <center><a style="color:black;font-size: 20px;" href="<?= base_url()?>dashboard/view_contacts">My Contact List</a></center>
  </body>
</html>